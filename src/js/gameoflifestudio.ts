...
class GameOfLifeStudio {
    ...
    public ctx: CanvasRenderingContext2DWithReset;
    ...
    public startStopBtn: HTMLElement | null;
    public resetBtn: HTMLElement | null;
    public randomBtn: HTMLElement | null;
    public clearBtn: HTMLElement | null;
    public speedSlider: HTMLInputElement | null;
    public speedValue: HTMLElement | null;
    public pixelGridToggle: HTMLInputElement | null;
    public gridToggle: HTMLInputElement | null;
    public fadeToggle: HTMLInputElement | null;
    public fadeSettings: HTMLElement | null;
    public fadeSlider: HTMLInputElement | null;
    public fadeValue: HTMLElement | null;
    public fadeMax: HTMLElement | null;
    public maturityToggle: HTMLInputElement | null;
    ...
    // Pattern elements
    public patternSearch: HTMLInputElement | null;
    ...
    public gridWidthMax: HTMLElement | null;
    public gridHeightSlider: HTMLInputElement | null;
    public gridHeightValue: HTMLElement | null;
    public gridHeightMax: HTMLElement | null;
    public cellSizeSlider: HTMLInputElement | null;
    public cellSizeValue: HTMLElement | null;
    public cellSizeMax: HTMLElement | null;
    public randomDensitySlider: HTMLInputElement | null;
    public randomDensityValue: HTMLElement | null;
    public randomDensityMax: HTMLElement | null;
    public randomSeedInput: HTMLInputElement | null;
    public generateSeedBtn: HTMLElement | null;
    public speedMax: HTMLElement | null;
    
    // Sidebar elements
    public sidebarToggle: HTMLElement | null;
    public sidebar: HTMLElement | null;
    public mobileMenuBtn: HTMLElement | null;
    public sidebarOverlay: HTMLElement | null;
    
    // Theme and display elements
    public darkModeToggle: HTMLInputElement | null;
    public fullscreenBtn: HTMLElement | null;
    public exitFullscreenBtn: HTMLElement | null;
    public gameContainer: HTMLElement | null;
    public fullscreenFloatingControls: HTMLElement | null;
    public fullscreenPlayPauseBtn: HTMLElement | null;
    public fullscreenShuffleBtn: HTMLElement | null;
    public fullscreenClearBtn: HTMLElement | null;
    
    // Custom rules elements
    public rulePresets: HTMLSelectElement | null;
    public customRuleInputs: HTMLElement | null;
    ...
    constructor(canvasId: string) {
        ...
        for (let i = 0; i <= 8; i++) {
            this.birthCheckboxes[i] = document.getElementById(`birth${i}`) as HTMLInputElement | null;
            this.survivalCheckboxes[i] = document.getElementById(`survive${i}`) as HTMLInputElement | null;
        }
